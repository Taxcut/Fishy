...
public class AdvancedLicense {
	...
	public boolean register(){
		   log(0, "------------------------------");
	        log(0, "Conneecting to the fAbilities license system!");
	        ValidationType vt = isValid();
	        if(vt == ValidationType.VALID){
	            log(0, "------------------------------");
	            log(1, "HIWD: " + Main.getInstance().getConfig().getString("License"));
	            log(1, "Status: Valid");
	            log(1, "The plugin is enabled! If you have any questions please contact Landen#3206 or Jack A.#0001 on Discord!");
	            log(0, "------------------------------");
	            return true;
	        }else{
	            /*
	            ...
	            log(1, ChatColor.RED + "If you think this is a mistake contact Landen#3206 or Jack A.#0001 on Discord!");
	            log(0, "------------------------------");
