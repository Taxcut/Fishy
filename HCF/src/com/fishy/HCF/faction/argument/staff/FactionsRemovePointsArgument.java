...
public class FactionsRemovePointsArgument extends CommandArgument {

    private final HCF plugin;

    public FactionsRemovePointsArgument (final HCF plugin) {
        super("removepoints", "Removes the points of a faction");
        this.plugin = plugin;
