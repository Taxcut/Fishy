...
public class FactionForceLeaderArgument extends CommandArgument {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        playerFaction.broadcast(ChatColor.WHITE + sender.getName() + " has forcefully set the leader to " + newLeaderName + '.');

        sender.sendMessage(ChatColor.GREEN.toString() + ChatColor.BOLD + "Leader of " + playerFaction.getName() + " was forcefully set from " + oldLeaderName + " to " + newLeaderName + '.');
        return true;
    }
