...
public class FactionClearClaimsArgument extends CommandArgument {
    ...
    private static class ClaimClearAllPrompt extends StringPrompt {
        ...
        public String getPromptText(ConversationContext context) {
            return ChatColor.WHITE + "Are you sure you want to do this? " + ChatColor.RED + ChatColor.BOLD + "All claims" + ChatColor.WHITE + " will be cleared. " +
                    "Type " + ChatColor.GREEN + "yes" + ChatColor.WHITE + " to confirm or " + ChatColor.RED + "no" + ChatColor.WHITE + " to deny.";
        }
