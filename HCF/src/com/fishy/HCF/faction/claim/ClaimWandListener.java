...
import com.fishy.hcf.visualise.VisualBlock;
    ...
    public void onPlayerInteract(PlayerInteractEvent event) {
        ...
        if (action == Action.LEFT_CLICK_BLOCK || action == Action.RIGHT_CLICK_BLOCK) {
            ...
            if (plugin.getClaimHandler().canClaimHere(player, blockLocation)) {
                ...
                player.sendMessage(ChatColor.WHITE + "Set the location of the claim selection " + selectionId + " to: " +
                        ChatColor.RED + blockX + ", " + blockZ);
                ...
                if (claimSelection.hasBothPositionsSet()) {
                    ...
                    player.sendMessage(ChatColor.WHITE + "Claim cost: " + (selectionPrice > playerFaction.getBalance() ? ChatColor.RED : ChatColor.GREEN) +
                            EconomyManager.ECONOMY_SYMBOL + selectionPrice);
                    player.sendMessage(ChatColor.GREEN + "Current Size: " + claim.getWidth() + ", " + claim.getLength() + ChatColor.GRAY + " (" + claim.getArea() + ")");
                }
