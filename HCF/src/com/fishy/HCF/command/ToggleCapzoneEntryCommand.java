...
public class ToggleCapzoneEntryCommand implements CommandExecutor, TabExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        sender.sendMessage(ChatColor.WHITE + "You will now " + (newStatus ? ChatColor.GREEN.toString() : ChatColor.RED + "un") + "able" +
                ChatColor.WHITE + " to see capture zone entry messages.");
