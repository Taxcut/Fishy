package com.fishy.hcf.util.base;
...
/**
 * <p>Adapted from ExperienceUtils code originally in ScrollingMenuSign.</p>
 * <p>Credit to nisovin (http://forums.bukkit.org/threads/experienceutils-make-giving-taking-exp-a-bit-more-intuitive.54450/#post-1067480)
 * for an implementation that avoids the problems of getTotalExperience(), which doesn't work properly after a player has enchanted something.</p>
 * <p>Credit to comphenix for further contributions:
 * See http://forums.bukkit.org/threads/experiencemanager-was-experienceutils-make-giving-taking-exp-a-bit-more-intuitive.54450/page-3#post-1273622</p>
 *
 * @author desht
 */
public class ExperienceManager {
     ...
     *
     * @param exp the exp to calculate
     * @return the calculated level for exp
     */
